            ...
            <div className="w-full md:w-[70vw] h-[500px] ">
                ...
                <div className="flex flex-row mt-[50px] justify-center">
                    <div className="mr-[50px] group flex relative flex-col">
                        <a href="https://austin-kappa.vercel.app/"><img src="img/austin.png" alt="Austin" className="w-[150px] h-[150px] rounded-[15px]"/></a>
                    ...
                    <div className="mr-[50px] group flex relative flex-col">
                        <a href="https://odin-library-eta.vercel.app/"><img src="img/library-app.png" alt="Library-App" className="w-[150px] h-[150px] rounded-[15px]"/></a>
                    ...
                    <div className="mr-[50px] group flex relative flex-col">
                        <a href="https://todo-app-weld-delta.vercel.app/"><img src="img/todoapp.png" alt="Todo-App" className="w-[150px] h-[150px] rounded-[15px]"/></a>
                        <span class="group-hover:opacity-100 transition-opacity bg-gray-800 px-1 w-[300px] h-[120px] text-sm text-gray-100 rounded-md absolute left-1/2 -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto">A CRUD app in a form of todo app. <br /> more complex than the library app, utilizes react states and localstorage <br /> (Click here to visit the Library-app!)</span>
                        <h1 className="text-center text-white text-[20px]">Todo-App</h1>
                    </div>
